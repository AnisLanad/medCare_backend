...
import { DynamicTableComponent } from '../pharmacist_table/dynamic-table.component';
...
@Component({
  ...
  templateUrl: './phar.component.html',
  styleUrl: './phar.component.css',
})
export class PatientsComponent {
  ...
  patientsColumns: TColumn<Tpharmacist>[] = [
    { key: 'id', label: 'ID' },
    { key: 'prescreption', label: 'Prescreption' },
