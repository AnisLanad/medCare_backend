...
@Component({
  ...
  template: `
    <div class="grid grid-cols-[60px_120px_1fr_1fr_1fr_100px] gap-4 items-center p-3 border-b border-gray-300 hover:bg-gray-100">
      <!-- ID -->
      ...
      <!-- Insurance -->
      <div class="truncate">{{ patient.insurance }}</div>
      <!-- NSS (Security Number) -->
